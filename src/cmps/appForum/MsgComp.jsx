...
export const MsgComp = ({
  ...
  const onLikeClick = async () => {
    if (Object.keys(currUser).length) {
      ...
      socketService.emit("like-change", {
        answer,
        selectedMsg,
        cluster,
        subject,
  ...
  return (
    <>
      ...
      answer.createdBy.userId === currUser._id ? (
        <div className="by-curr-user msg-container">
          ...
          <div className="answer by-user msg">
            ...
            <span className="sent-at">
              {utilService.getFormatedDateWithTime(new Date(answer.createdAt))}
            </span>
          </div>
        </div>
      ) : (
        <div className="answer-container">
          <div className="answer-like-div">
            {likesState.includes(currUser._id) && (
              <span
                className="thumbs-up"
                onClick={onLikeClick}
            ...
            {!likesState.includes(currUser._id) && (
              <span className="thumbs-up" onClick={onLikeClick}>
                <i className="fa-solid fa-thumbs-up"></i>
              </span>
            )}
